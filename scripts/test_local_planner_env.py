...
Usage:
    ...
    # 無頭模式（headless）
    ./isaaclab.sh -p scripts/test_local_planner_env.py --headless
    
    # 指定環境數量
    ./isaaclab.sh -p scripts/test_local_planner_env.py --num_envs 4
"""
...
# 解析命令列參數
parser = argparse.ArgumentParser(description="測試 Nova Carter 本地規劃器環境")
...
def main():
    ...
    print(f"  - 回合長度: {env.unwrapped.max_episode_length}")
